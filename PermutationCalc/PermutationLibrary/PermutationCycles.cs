...
namespace PermutationLibrary
{
    ...
    public class PermutationCycles
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="Cycles">Cycles list</param>
        public PermutationCycles(List<int[]> Cycles)
        {
            cycleList = Cycles;
        }
        /// <summary>
        ...
        {
            cycleList = PermutationConvert.CycleNotationToCycles(text);
        }
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public static PermutationCycles Composition(PermutationCycles p1, PermutationCycles p2)
        {
