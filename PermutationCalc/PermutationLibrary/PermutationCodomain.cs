...
namespace PermutationLibrary
{
    ...
    public class PermutationCodomain
    {
        ...
        {
            codomain = PermutationConvert.CycleNotationToCodomain(text);
        }
        ...
        public static PermutationCodomain Composition(PermutationCodomain p1, PermutationCodomain p2, out string textOperation)
        {
